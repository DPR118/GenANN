classdef GenANNCon < handle
    %GENANNCON controller to perform genetic optimization on a population
...
%     and the least cost. As of now it only saves based cost.
    ...
    methods
        function obj= GenANNCon(PopulationSize,Species,Iterations,Survivors,PenaltyFunction,Neurons,Inputs,Targets)
